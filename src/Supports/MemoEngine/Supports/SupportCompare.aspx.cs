...
{
    public partial class SupportCompare : System.Web.UI.Page
    {
        public string ChartLabels { get; set; }
        public string ChartDatas { get; set; }
        public string ChartTitle { get; set; } = "조회수";
        ...
        public List<CompareReportViewModel> Model { get; set; } = new List<CompareReportViewModel>();
