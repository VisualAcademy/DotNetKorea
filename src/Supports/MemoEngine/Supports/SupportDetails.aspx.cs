...
{
    public partial class SupportDetails : System.Web.UI.Page
    {
        ...
        {
            _repository = new SupportRepository(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // 삭제, 수정, 답변 링크 만들기 
            lnkDelete.NavigateUrl = "SupportDelete.aspx?Id=" + _Id.ToString();
            lnkModify.NavigateUrl = "SupportEdit.aspx?Id=" + _Id.ToString();
            lnkReply.NavigateUrl = "SupportReply.aspx?Id=" + _Id.ToString();
