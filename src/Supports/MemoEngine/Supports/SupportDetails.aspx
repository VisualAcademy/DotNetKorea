<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard/DashboardCore.Master" AutoEventWireup="true" CodeBehind="SupportDetails.aspx.cs" Inherits="MemoEngine.Supports.SupportDetails" %>

<%@ Register Src="~/Supports/Controls/BoardCommentControl.ascx" TagPrefix="uc1" TagName="BoardCommentControl" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="text-align: center;">
                                ...
                                <asp:HyperLink ID="lnkList" runat="server" NavigateUrl="SupportIndex.aspx" CssClass="btn btn-primary">리스트</asp:HyperLink>
                            </div>
