<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardSearchFormSingleControl.ascx.cs" Inherits="MemoEngine.Supports.Controls.BoardSearchFormSingleControl" %>
...
<% if (!string.IsNullOrEmpty(Request.QueryString["SearchField"]) && !String.IsNullOrEmpty(Request.QueryString["SearchQuery"]))
    { %>
<div style="text-align: center;">
    <a href="/Supports/SupportIndex.aspx" class="btn btn-success">검색 완료</a>
</div>
<% } %>
