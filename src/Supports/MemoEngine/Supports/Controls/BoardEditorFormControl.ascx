<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardEditorFormControl.ascx.cs" Inherits="MemoEngine.Supports.Controls.BoardEditorFormControl" %>
                ...
                <table style="width: 700px; border-collapse: collapse; padding: 5px; margin-left: auto; margin-right: auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <asp:Image ID="imgSecurityImageText" runat="server" ImageUrl="~/Supports/ImageText.aspx" />
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            ...
                            <a href="SupportIndex.aspx" class="btn btn-primary">리스트</a>
                            <br />
