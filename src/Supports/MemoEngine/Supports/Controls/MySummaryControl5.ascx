<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MySummaryControl5.ascx.cs" Inherits="MemoEngine.Supports.Controls.MySummaryControl5" %>
...
<asp:ObjectDataSource ID="objSupports" runat="server"
    EnablePaging="true"
    TypeName="MemoEngine.Supports.Controls.MySupport5"
