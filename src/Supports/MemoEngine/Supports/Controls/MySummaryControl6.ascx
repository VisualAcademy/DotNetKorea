<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MySummaryControl6.ascx.cs" Inherits="MemoEngine.Supports.Controls.MySummaryControl6" %>
...
<asp:ObjectDataSource ID="objSupports" runat="server"
    EnablePaging="true"
    TypeName="MemoEngine.Supports.Controls.MySupport6"
