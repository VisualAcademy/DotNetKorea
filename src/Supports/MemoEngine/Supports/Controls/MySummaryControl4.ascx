<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MySummaryControl4.ascx.cs" Inherits="MemoEngine.Supports.Controls.MySummaryControl4" %>
...
<asp:ObjectDataSource ID="objSupports" runat="server"
    EnablePaging="true"
    TypeName="MemoEngine.Supports.Controls.MySupport4"
