<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MySummaryControl3.ascx.cs" Inherits="MemoEngine.Supports.Controls.MySummaryControl3" %>
...
<asp:ObjectDataSource ID="objSupports" runat="server"
    EnablePaging="true"
    TypeName="MemoEngine.Supports.Controls.MySupport3"
