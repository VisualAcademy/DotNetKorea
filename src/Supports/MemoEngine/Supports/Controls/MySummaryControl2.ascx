<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MySummaryControl2.ascx.cs" Inherits="MemoEngine.Supports.Controls.MySummaryControl2" %>
...
<asp:ObjectDataSource ID="objSupports" runat="server"
    EnablePaging="true"
    TypeName="MemoEngine.Supports.Controls.MySupport2"
