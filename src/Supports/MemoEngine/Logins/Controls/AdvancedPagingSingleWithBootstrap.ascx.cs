    ...
    public partial class AdvancedPagingSingleWithBootstrap : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                !String.IsNullOrEmpty(HttpContext.Current.Request["SearchField"]))
            {
                ...
                SearchQuery = HttpContext.Current.Request["SearchQuery"];
                StartDate = EncodeSqlString(HttpContext.Current.Request["StartDate"]);
                EndDate = EncodeSqlString(HttpContext.Current.Request["EndDate"]);
            }
            #endregion
